...
class TrendEngine:
    ...
    def fetch_data(self):
        """Joins the tables and returns a clean DataFrame."""
    ...
    def get_timeseries_trends(self, df, freq='D'):
        ...
        relative_trends = pivot_df.divide(total_jobs, axis=0) * 100
        return relative_trends

    def calculate_momentum(self, trend_df, window=3):
        """Identifies which skills are growing fastest (the ML feature)."""
