...
class AWSSettings(BaseSettings):
    ...
    raw_bucket: str = Field("amzn-s3-raw-bucket-skillex", alias="AWS_RAW_BUCKET")
    processed_bucket: str = Field("amzn-s3-processed-bucket-skillex", alias="AWS_PROCESSED_BUCKET")
    models_bucket: str = Field("amzn-s3-models-bucket", alias="AWS_MODELS_BUCKET")
...
class Settings(BaseSettings):
    ...
    @classmethod
    def load_config(cls, yaml_path: str = "shared/config/config.yaml") -> "Settings":
